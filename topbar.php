...
<!--         <?php if(isset($_SESSION['login_id'])): ?>
      ...
      <?php endif; ?> -->
        <li>
          <a class="nav-link text-white"  href="./" role="button"> <large><b>Vilnius Tech gidas</b></large></a>
        </li>
      </ul>
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link nav-home" href="uzimtumas.php">
            <b>Auditorijų užimtumas</b>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link nav-home" href="apie.php">
            <b>Apie</b>
          </a>
        </li>
