  ...
  <div class="card card-outline card-primary">
    <div class="card-header">
      <div class="card-tools">
        <a class="btn btn-block btn-sm btn-default btn-flat border-primary" href="./index.php?page=nauja"><i class="fa fa-plus"></i> Pridėti naują</a>
      </div>
    </div>
    <div class="card-body">
      <table class="table tabe-hover table-bordered" id="list">
        ...
        <tbody>
          ...
          while($row= $qry->fetch_assoc()):
            ...
            $desc = strtr(html_entity_decode($row['vieta']),$trans);
            $desc=str_replace(array("<li>","</li>"), array("",", "), $desc);
          ?>
          <tr>
            <th class="text-center"><?php echo $i++ ?></th>
            <td><b><?php echo ucwords($row['laikas']) ?></b></td>
            <td><b class="truncate"><?php echo strip_tags($desc) ?></b></td>
            <td class="text-center">
                        <div class="btn-group">
                            <a href="./index.php?page=redaguoti&id=<?php echo $row['id'] ?>" class="btn btn-primary btn-flat">
